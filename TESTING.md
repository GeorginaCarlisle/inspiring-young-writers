...
All CSS has been generated through tailwind css. When passing through the validator a number of errors and warnings were raised. However as output.css is generated by tailwind these were not something I could fix
...
| 14 | As a **signed-in user** I can edit my profile | Future Feature | | |
| 15 | As a **signed-in user** I can delete my account | Future Feature | | |
| 16 | As the **parent of a registered user** I am informed of any profile changes my child makes and my consent to any changes is required | Future Feature | | |
...
| 25 | As a **signed-in user** I am provided with tips and ideas for the sort of work I could create | Future Feature | | |
...
| 28 | As a **signed-in user** I can write a blurb for my writing | Future Feature | | |
| 29 | As a **signed-in user** I can attach a picture to my writing | Future Feature | | |
...
| 36 | As the **site admin** I am informed when a child submits their writing for approval | Future Feature | | |
...
| 41 | As a **signed-in user** I can filter work | Future Feature | | |
| 42 | As a **signed-in user** I can click a help button should I see/read something I don’t like | Future Feature | | |
| 43 | As the **parent of a signed-in user** my child is prompted to seek out my guidance should they see/read something they don’t like | Future Feature | | |
| 44 | As the **parent of a signed-in user** I can raise concern about a specific piece of writing | Future Feature | | |
| 45 | As the **site admin** I am alerted immediately to any raised concerns | Future Feature | | |
...
| 51 | As a **signed-in user** I am alerted to any new feedback on my published work | Future Feature | | |
...
| | | Editing my work passes all user story #33 criteria | PASS | PASS |
| 54 | As a **signed-in user** I can delete feedback given to me by other users | Future Feature | | |
| 55 | As a **signed-in user** I can click a help button should I see something in the feedback that worries me | Future Feature | | |
| 56 | As the **parent of a signed-in user** my child is prompted to seek out my guidance should they see/read something in the feedback that worries them | Future Feature | | |
| 57 | As the **parent of a signed-in user** I can raise concern about a specific piece of feedback | Future Feature | | |
| 58 | As the **site admin** I am alerted immediately to any raised concerns about feedback | Future Feature  | | |
...
| Trigger | Expected Response | 1st Check | Final Check |
| --- | --- | --- | --- |
| Clicking the 'x' to come out of the create view | Confirmation message and two buttons 'keep creating' and 'head back' | PASS | PASS |
